...
```mermaid
flowchart LR
    A["Einfall am Tresen"] --> B["Idee in /ideen<br/>(Säule, Aufwand, Voting)"]
    B --> C["Montag: Voting<br/>Top-Ideen ausgewählt"]
    C --> D["Pipeline: Entwurf<br/>Skript + Caption aus Vorlage"]
    D --> E["Mittwoch: Produktion<br/>Medien hochgeladen"]
    E --> F["Donnerstag: Review<br/>Freigabe"]
    F --> G["Freitag: Geplant<br/>Beste Zeit, UTM, Kampagne"]
    G --> H["Veröffentlicht"]
    H --> I["Nach 7 Tagen: Analytics<br/>Learning zurück in Ideen"]
    I -.-> B
```
