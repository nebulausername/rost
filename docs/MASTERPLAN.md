...
flowchart LR
    subgraph A["1 · Awareness"]
        A1["Reel: Röstprotokoll"]
        A2["Google Maps: Café in der Nähe"]
        A3["Hotel- oder Freundes-Tipp"]
        A4["Meta-Ad Lokal"]
    end
    subgraph B["2 · Consideration"]
        B1["Instagram-Profil und Highlights"]
        B2["Website: Bohnen-Pass und Brühanleitung"]
        B3["Google-Bewertungen"]
        B4["Retargeting-Ad"]
    end
    subgraph C["3 · Kauf / Besuch"]
        C1["Café-Besuch"]
        C2["Shop-Kauf"]
        C3["Workshop-Buchung"]
    end
    subgraph D["4 · Bindung"]
        D1["Newsletter und Stempelkarte"]
        D2["Kaffee-Abo"]
    end
    subgraph E["5 · Empfehlung"]
        E1["Google-Bewertung"]
        E2["UGC und Story-Markierung"]
        E3["Geschenk und Empfehlungscode"]
    end
    A1 --> B1
    A2 --> B3
    A3 --> C1
...
flowchart TD
    ...
    H --> C["Cafés"]
    H --> BW["Brüh-Wissen"]
    H --> HK["Herkunft und Import"]
    H --> U["Über uns"]
    H --> B2B["Für Gastro und Büro"]
    S --> S1["Espresso"]
    S --> S2["Filter"]
    S --> S3["Geschenke und Gutscheine"]
    S --> S4["Zubehör und Merch"]
    S --> S5["Geschmacksfinder-Quiz"]
    S1 --> P["Produktseite mit Bohnen-Pass"]
    S2 --> P
    AB --> AB1["Abo-Konfigurator"]
    AB --> AB2["Abo verschenken"]
    AB --> AB3["Mein Abo verwalten"]
    W --> W1["Workshop-Kalender"]
    W --> W2["Firmen- und Gruppen-Workshops"]
    W --> W3["Gutschein"]
    C --> C1["Rösterei und Café · Richard-Wagner-Str. 17"]
    C --> C2["Espressobar · Herderplatz"]
    BW --> BW1["Brühanleitungen: V60, AeroPress, French Press, Siebträger, Mokka"]
    BW --> BW2["Mahlgrad-Guide und Rezeptrechner"]
    BW --> BW3["Kaffee-Lexikon"]
    HK --> HK1["Unsere Importwege"]
    HK --> HK2["Bohnen-Pässe aller Kaffees"]
    U --> U1["Die Brüder und das Team"]
    U --> U2["Presse und Guides"]
    U --> U3["Jobs"]
    B2B --> B1["Büro-Abo"]
    B2B --> B2["Gastro-Partnerschaft"]
    B2B --> B3["Wiederverkauf"]
```
...
```mermaid
gantt
    title Röstbrüder Roadmap Okt 2026 bis Sep 2027
    dateFormat YYYY-MM-DD
    axisFormat %b %y

    section Phase 1 Fundament
    Baseline-KPIs erfassen             :p1a, 2026-09-28, 12d
    Google-Profile optimieren           :p1b, 2026-10-01, 14d
    Tracking und Consent Mode v2        :p1c, 2026-10-05, 26d
    Studio MVP im Alltag                :p1d, 2026-10-05, 60d
    Tag des Kaffees                     :milestone, m1, 2026-10-01, 0d
    Zwiebelmarkt (Termin prüfen)        :p1e, 2026-10-09, 3d
    Geschenk-Kategorie und Geschenk-Abo :p1f, 2026-10-19, 21d
    Black Friday Kampagne               :p1g, 2026-11-20, 11d
    Weihnachtskampagne                  :p1h, 2026-11-23, 28d
    Relaunch-Entscheidung               :milestone, m2, 2026-12-15, 0d

    section Phase 2 Relaunch
    Konzept und Design Website          :p2a, 2027-01-04, 31d
    Bohnen-Pass alle Kaffees            :p2b, 2027-01-18, 35d
    Umsetzung Website                   :p2c, 2027-02-01, 49d
    Studio Phase 2 Supabase             :p2d, 2027-01-11, 70d
    Relaunch Go-live                    :milestone, m3, 2027-03-22, 0d
    Jubiläum 7 Jahre                    :p2e, 2027-03-19, 10d

    section Phase 3 Sommer
    Terrassen-Opening                   :p3a, 2027-04-10, 3d
    Muttertag Kampagne                  :p3b, 2027-04-26, 14d
    Cold-Brew-Launch                    :p3c, 2027-05-17, 14d
    Studio Phase 3 API-Publishing       :p3d, 2027-04-05, 84d
    Hotel- und Touristik-Partner        :p3e, 2027-04-01, 91d

    section Phase 4 Optimieren
    B2B-Offensive                       :p4a, 2027-07-01, 70d
    Studio Phase 4 KI-Assistent         :p4b, 2027-07-05, 70d
    A/B-Tests Shop                      :p4c, 2027-07-12, 56d
    Jahresreview und Plan 27/28         :p4d, 2027-09-01, 21d
```
